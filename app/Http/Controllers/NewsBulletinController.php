...
class NewsBulletinController extends Controller
{
    ...
    function pdfDataPrepare($date_id, $dist, $path){
        ...
        return [
            ...
            'third_chart'=> ['title'=> "Daily Positivity Rate Comparison between {$_district_name} District and National", 'path'=> $path.'/chart2.png'],
            'fourth_chart'=> ['title'=> "Location of Active Covid-19 Cases in {$_district_name} District", 'path'=> $path.'/chart3.png'],
        ];
