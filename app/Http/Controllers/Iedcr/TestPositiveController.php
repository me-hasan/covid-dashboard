...
class TestPositiveController extends Controller
{
    ...
    private function getLocationWiseTestPositivity($request) {
        ...
        if($request->division && $request->district && $request->upazila){
            ...
            $locationWiseTestPositive = DB::select("select a.district as District, a.total_tests as total_test, a.positive_tests as positive, round((a.positive_tests/a.total_tests), 2)*100 
