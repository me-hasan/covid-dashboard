<?php return array (
  ...
  array (
    ...
    'env' => 'development',
    'debug' => false,
    'url' => 'http://172.17.129.30/',
    'asset_url' => NULL,
    'timezone' => 'Asia/Dhaka',
    'locale' => 'en',
    'fallback_locale' => 'en',
    'faker_locale' => 'en_US',
    'key' => 'base64:+mD39lV9CEjVp6hNrDawEQsSiPJc2CTddGkQKMQK1mQ=',
    'cipher' => 'AES-256-CBC',
    'providers' => 
    array (
  ...
  array (
    ...
    'prefix' => 'national_database_cache',
  ),
  'cors' => 
  array (
    'paths' => 
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'port' => '3306',
        'database' => 'national_dashboard',
        'username' => 'national_dash_user',
        'password' => 'Covid2$0Egen!Dash',
        'unix_socket' => '',
        'charset' => 'utf8mb4',
    ...
    array (
      ...
      array (
        'cluster' => 'redis',
        'prefix' => 'national_database_database_',
      ),
      'default' => 
      array (
        'url' => NULL,
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'url' => 'http://172.17.129.30//storage',
        'visibility' => 'public',
      ),
      's3' => 
      array (
  ...
  array (
    ...
    'cookie' => 'national_database_session',
    'path' => '/',
    'domain' => NULL,
    'secure' => NULL,
    'http_only' => true,
