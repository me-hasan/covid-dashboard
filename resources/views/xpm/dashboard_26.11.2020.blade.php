...
using(district) ORDER BY r.test_positivity DESC");
                                                ...
                                                <div class="col-xl-8 col-md-8">
                                                    <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar">
                                                        <table
                                                            ...
                                                            <tr>
                                                                <td>কম ঝুঁকিপূর্ণ</td>
                                                                <td style="background: #ff6666; cursor: pointer;"
                                                                    class="low_to_high_modal_click"
                                                                    data-target="#modaldemo1"
                                                                    data-toggle="modal">{{ convertEnglishDigitToBangla($rm_1->low_to_high) }}
                                                                    টি জেলা
                                                                </td>
                                                                <td style="background: #ffa500; cursor: pointer;text-decoration: none;"
                                                                    class="low_to_medium_modal_click"
                                                                    data-target="#modaldemo1"
                                                                    data-toggle="modal">{{ convertEnglishDigitToBangla($rm_2->low_to_medium) }}
                                                                    টি জেলা

                                                                    মহামারি শুরুর পর থেকে দেশজুড়ে আক্রান্ত রোগীর সংখ্যা নির্দেশ করছে। নীল বার গুলোতে দৈনিক আক্রান্তের সংখ্যা ও কমলা লাইনের মাধ্যমে ৫ দিনের আক্রান্তের গড় সংখ্যা দেখানো হয়েছে। এখানে লক্ষণীয় এই যে, আগস্ট মাসের ২ এবং ৩ তারিখে পবিত্র ঈদুল আজহার কারণে পরীক্ষার সংখ্যা কমেছে এবং আক্রান্তের সংখ্যা কম দেখা যাচ্ছে।
                                                                </td>
                                                                <td style="background: #1ad433; cursor: pointer;"
                                                    ...
                                                    <div
                                                        ...
                                                        <table
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th class="text-center fs-18"
                                                                    style="border:2px solid black; background: #cbc5c5;">
                                                                    অপরিবর্তিত মধ্যম ঝুঁকি
                                                                </th>
                                                                <th class="text-center fs-18"
                                                                ...
                                                                <th class="text-center fs-18"
                                                                    style="border:2px solid black; background: #1ad433; border-bottom: 0px solid !important;">
                                                            ...
                                                            <tr>
                                                                <th class="text-center"
                                                                    style="border: 2px solid black;background: white;color: black;border-bottom: 0px solid #000 !important;">
    ...
    border-bottom: 0px solid !important;">
                                                                ...
                                                                <th class="text-center"
                                                                    style="border:2px solid black;background: white;color:black; border-bottom: 0px solid !important;">
                                                            ...
                                                            <tr>
                                                                <td class="text-center low_to_high_district"
                                                                    style="border-top: 0px solid #000 !important;">{{ implode(", ",$low_to_high) }}</td>
                                                                <td class="text-center medium_to_high_district"
                                                                    style="border-top: 0px solid #000 !important;">{{ implode(", ",$medium_to_high) }}</td>
    ...
    border-top: 0px solid !important;"
                                                                ...
                                                                <td class="text-center medium_to_low_district"
                                                                    style="border:2px solid black; border-top: 0px solid red !important;">{{ implode(", ",$medium_to_low) }}</td>
                                                                <td class="text-center high_to_low_district"
                                                                    style="border: 2px solid black;
    border-top: 0px solid red !important;">{{ implode(", ",$high_to_low) }}</td>
                                                            </tr>
                                                            <tr>
                                                                <th class="text-center"
                                                                    style="border-top: 0px solid #000 !important;color: black;border-bottom: 0px solid #000 !important;">
    ...
    border-bottom: 0px solid !important;">
                                                            ...
                                                            <tr>
                                                                <td class="text-center high_to_high_district"
                                                                    style="border-top: 0px solid #000 !important;">{{ implode(", ",$high_to_high) }}</td>
                                                                <td class="text-center low_to_medium_district"
                                                                    style="border:2px solid black;border-top: 0px solid !important;">{{ implode(", ",$low_to_medium) }}</td>

                                                                <td class="text-center high_to_medium_district"
                                                                    style="border:2px solid black; border-top: 0px solid !important;">{{ implode(", ",$high_to_medium) }}</td>
                                                                <td class="text-center low_to_low_district"
                                                                    style="border:2px solid black; border-top: 0px solid !important;">{{ implode(", ",$low_to_low) }}</td>
                                                            </tr>
...
{{-- Loader --}}
<div id="loading-sniper" style="z-index: 99999; position: fixed; height: 100vh;width: 100%;top: 0px; left: 0; right: 0; bottom: 0px; background: rgba(0,0,0,.4); display: none; overflow: hidden;">
