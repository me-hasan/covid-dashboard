                                    ...
                                    <div id="high_to_high_table_content" class="table-responsive b1">
                                        <table id="risk_table_popup"
                                            ...
                                            <tr>
                                                ...
                                                <th class="border-bottom-0">গত ২ সপ্তাহের টেস্ট পজিটিভিটি (<spna style="color:#0636c1d4;">টেস্ট</span>, <span style="color:#b50514d4;">পজিটিভ</span>)</th>
                                                <th class="border-bottom-0">গত ৩য় ও ৪র্থ সপ্তাহের টেস্ট পজিটিভিটি (<spna style="color:#0636c1d4;">টেস্ট</span>, <span style="color:#b50514d4;">পজিটিভ</span>)</th>
                                            </tr>
                                            </thead>
                                            <tbody>
