    ...
    <div class="container-fluid">
        <div class="d-flex">
            ...
            <div class="form-group mb-0 mt-3">
                <div class="custom-controls-stacked d-flex">
                	<label class="custom-control custom-radio mr-2">
                        <input type="radio" class="custom-control-input" name="lang" value="bn" checked>
                        <span class="custom-control-label">বাংলা</span> </label>
                    <label class="custom-control custom-radio mr-2">
                        <input type="radio" class="custom-control-input" name="lang" value="en" disabled>
                        <span class="custom-control-label">ইংরেজি</span> </label>
                </div>
            </div>
            ...
            <div class="d-flex order-lg-2 ml-auto">
                <form action="{{ route('dashboard') }}" method="get" class="d-flex order-lg-12 ml-auto">
                    @include('administrative.search_view')
                </form>
            </div>
