...
<div class="main-panel">
    ...
    <div class="row">
        ...
        <div class="d-flex flex-row mb-3 box-wrapper">
            ...
            <div class="num-style">
                <spam id="last_infected">২,৭৩৩</spam>
                <span class="text-danger"><i class="mdi mdi-arrow-up-circle menu-icon"></i></span> </div>
            </div>
            ...
            <div class="num-style"> <span id="last_recovered"> ১,৯৪০</span> <span class="text-success"><i class="mdi mdi-arrow-up-circle menu-icon"></i></span> </div>
            </div>
            ...
            <div class="num-style"> <span id="last_dead">৩৯</span> <span class="text-danger"><i class="mdi mdi-arrow-up-circle menu-icon"></i></span> </div>
            </div>
            ...
            <div class="num-style"> <span id="last_test">১২,৮৮৯</span> <span class="text-success"><i class="mdi mdi-arrow-up-circle menu-icon"></i></span> </div>
            </div>
            ...
            <div class="num-style" id="total_infected">১৯৬,৩২৩</div>
            </div>
            ...
            <div class="num-style text-success" id="total_recovered">১০৬,৯৬৩</div>
            </div>
            ...
            <div class="num-style text-danger" id="total_dead">২,৪৯৬</div>
            </div>
            ...
            <div class="num-style" id="total_test">৯৯৩,২৯১</div>
            </div>
        </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="card">
            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-5">
                    <div class="py-1" style="text-align: center;"> <a class="float-right btn btn-link" href="dataframe.php?datatype=detailsmap">বিস্তারিত</a> <img src="assets/images/covid-19-bangladesh-map.png" alt="Covid-19" width="250" /> <img src="assets/images/bangladesh-map.png" alt="Covid-19" width="300" height="100" style="padding-bottom:20px;" />
        ...
        <div class="card">
            ...
            <table class="table table-sm table-bordered header-bg-color">
                ...
                <tr>
                    ...
                    <td><span class="line-chart-holder"><img src="assets/images/line-chart-1.png"> </span></td>
                </tr>
                <tr>
                ...
                <tr>
                    <th scope="row">পরীক্ষার জন্য গড় অপেক্ষা</th>
                    <td></td>
                    <td>1</td>
                    <td class="bg-danger">Infinity</td>
                    <td><span class="line-chart-holder"><img src="assets/images/line-chart-3.png"> </span></td>
                </tr>
                <tr>
                    <th scope="row">পরীক্ষার ফলাফল লাভের জন্য গড় অপেক্ষা</th>
                    <td>1,211</td>
                    <td>743</td>
    ...
    <div class="row">
        <div class="col-md-5 grid-margin stretch-card">
        <div class="card">
            <h5 class="card-header">বিভাগীয় অন্তর্গমন ও বহির্গমনের শতকরা হার</h5>
            <div class="card-body p-0 daily-charge">
            <ul class="nav nav-tabs justify-content-end mtm"
                                id="myTab3"
                                role="tablist">
                <li class="nav-item" role="presentation"> <a class="nav-link active" id="home-tab33" data-toggle="tab" href="#home33" role="tab" aria-controls="home33" aria-selected="true"> অন্তর্গমন </a> </li>
                <li class="nav-item" role="presentation"> <a class="nav-link" id="profile-tab33" data-toggle="tab" href="#profile33" role="tab" aria-controls="profile33" aria-selected="false">বহির্গমন</a> </li>
            </ul>
        ...
        <div class="col-md-7 grid-margin stretch-card">
        <div class="card">
            <h5 class="card-header">বিভাগীয় জনসংখ্যার ভিত্তিতে শতকরা আক্রান্তের হার</h5>
            <div class="card-body p-0 daily-charge">
            <ul class="nav nav-tabs justify-content-end mtm "
                                id="myTab2"
                                role="tablist">
                <li class="nav-item" role="presentation"> <a class="nav-link active" id="home-tab2" data-toggle="tab" href="#home2" role="tab" aria-controls="home2" aria-selected="true"> শীর্ষস্থানীয় শহর</a> </li>
                <li class="nav-item" role="presentation"> <a class="nav-link" id="profile-tab2" data-toggle="tab" href="#profile2" role="tab" aria-controls="profile2" aria-selected="false">বিভাগ</a> </li>
                <li class="nav-item" role="presentation"> <a class="nav-link" id="contact-tab2" data-toggle="tab" href="#contact2" role="tab" aria-controls="contact2" aria-selected="false"> জেলা</a> </li>
                <li class="nav-item" role="presentation"> <a class="nav-link" id="contact-tab22" data-toggle="tab" href="#contact22" role="tab" aria-controls="contact22" aria-selected="false"> উপজেলা</a> </li>
            </ul>
            <div class="tab-content" id="myTabContent2">
                ...
                <div class="tab-pane fade  text-center"
                                        id="profile2"
                                        role="tabpanel"
                                        aria-labelledby="profile-tab2"> <img src="assets/images/top-city.png"> </div>
                <div class="tab-pane fade  text-center"
                                        id="contact2"
                                        role="tabpanel"
                                        aria-labelledby="contact-tab2"> <img src="assets/images/top-city.png"> </div>
                <div class="tab-pane fade  text-center"
                                        id="contact22"
                                        role="tabpanel"
                                        aria-labelledby="contact-tab22"> <img src="assets/images/top-city.png"> </div>
            </div>
            </div>
        </div>
        </div>
