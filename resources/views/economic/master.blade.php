...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('pm/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('pm/css/font-awesome.min.css') }}">
    <link rel="stylesheet" href="{{ asset('pm/css/themify-icons.css') }}">
    <link rel="stylesheet" href="{{ asset('pm/css/metisMenu.css') }}">
    <link rel="stylesheet" href="{{ asset('pm/css/owl.carousel.min.css') }}">
    <link rel="stylesheet" href="{{ asset('pm/css/slicknav.min.css') }}">
    <!-- amchart css -->

    <link rel="stylesheet" href="{{ asset('pm/css/typography.css') }}">
    <link href="https://fonts.maateen.me/kalpurush/font.css" rel="stylesheet">
    <link href="https://fonts.maateen.me/bangla/font.css" rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('pm/css/default-css.css') }}">
    <link rel="stylesheet" href="{{ asset('pm/css/styles.css') }}">
    <link rel="stylesheet" href="{{ asset('pm/css/responsive.css') }}">
    <link href="{{ asset('assets/css/icons.css')}}" rel="stylesheet"/>
    <!-- modernizr css -->
    <script src="{{ asset('pm/js/vendor/modernizr-2.8.3.min.js') }}"></script>
    <link rel="stylesheet"
...
<div class="page-container">
    ...
    <div class="sidebar-menu">
        <div class="sidebar-header">
            <div class="logo">
                <a href="https://corona.gov.bd/"><img src="{{ asset('pm/images/icon/corona-logo.png') }}" alt="logo"></a>
            </div>
                ...
                <nav>
                    <ul class="metismenu" id="menu">
                        <li class="active">
                                    ...
                                    class=""></i><span>Socio-Economic Dashboard</span></a>
                        </li>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-11 clearfix">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <h1 class="head-title"><img style="height: 48px;" src="{{ asset('pm/images/icon/bd-logo.png') }}"
                                                        alt="logo">Socio Economic Dashboard </h1>
                        </div>
                    </div>
                        ...
                        <div class="collapse navbar-collapse" id="navbarNav">
                          <ul class="navbar-nav">
                            <li class="nav-item btn-info">
                              <a class="nav-link" href="{{ route('socio.economic') }}">Dashboard <span class="sr-only">(current)</span></a>
                            </li>
                            <li class="nav-item btn-primary">
                              <a class="nav-link" href="#">Food Security <span class="sr-only">(current)</span></a>
                            </li>
                            <li class="nav-item">
                              <a class="nav-link btn-warning" href="{{ route('socio.economic.education') }}">Education </a>
                            </li>
                            <li class="nav-item">
                              <a class="nav-link btn-secondary" href="{{ route('socio.economic.employment') }}">Employment </a>
                            </li>
                            <li class="nav-item">
                              <a class="nav-link btn-success" href="#">Injustice & Crime </a>
                            </li>
                            <li class="nav-item">
                              <a class="nav-link btn-danger" href="#">Vulnerable population </a>
                            </li>
                          </ul>
                        </div>
                      </nav>
...
<div class="p-8" style="margin-right: 414px"><img src="{{ asset('pm/images/icon/footer-logo.png') }}" class="footer-logo" alt="logo"
...
<div class="modal fade associates-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
    ...
    height: 130px;" alt="">
                        ...
                        <div class="col-md-4 text-center">
                            ...
                            <img src="{{ asset('pm/images/collaborator/dr_shams.l_arefin.jpg') }}" class="associator-img" alt="">
                        ...
                        <div class="col-md-4 text-center">
                            ...
                            <img src="{{ asset('pm/images/collaborator/anir-chowdhury.jpeg') }}" class="associator-img" alt="">
                            <p>আনীর চৌধুরী
                            </p>
                            <p>পলিসি এডভাইজর ,</p>
                            <p>এটুআই প্রোগ্রাম</p>
                ...
                <div class="row">
                    <div class="col-md-12 text-center mt-5">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <img src="{{ asset('pm/images/collaborator/dr_md_habibur_rahman.jpg') }}" class="associator-img"
                                     alt="">
                            ...
                            <div class="col-md-4">
                                <img src="{{ asset('pm/images/collaborator/engr_sukhendra_shekhor_roy.jpg') }}" class="associator-img"
                                     alt="">
                            ...
                            <div class="col-md-4">
                                <img src="{{ asset('pm/images/collaborator/dr_aysha_sania.jpg') }}" class="associator-img" alt="">
                                <p>ড. আয়েশা সানিয়া</p>
                                <p> রিসার্চ সায়েন্টিস্ট</p>
                                <p>কলাম্বিয়া বিশ্ববিদ্যালয়,যুক্তরাষ্ট্র</p>
                            </div>
                            <div class="col-md-4">
                                <img src="{{ asset('pm/images/collaborator/dr_mahbubur_rahman.jpg') }}" class="associator-img" alt="">
                                <p>ড. মাহবুবুর রহমান</p>
                                <p> সহকারী অধ্যাপক</p>
                                <p>আইইডিসিআর</p>
                            </div>
                            <div class="col-md-4">
                                <img src="{{ asset('pm/images/collaborator/dr_mallik_masum_billah.jpg') }}" class="associator-img"
                                     alt="">
                    ...
                    <div class="col-md-12 text-center mt-5">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <img src="{{ asset('pm/images/collaborator/tamanna_urmi.jpg') }}" class="associator-img"
                                     alt="">
                                <p>তামান্না উর্মি</p>
                            ...
                            <div class="col-md-4">
                                ...
                                <img src="{{ asset('pm/images/collaborator/dr_dewan_mohammad_humayon_kabir.jpg') }}"
    ...
    height: 200px;">
                            ...
                            <div class="col-md-4">
                                ...
                                <img src="{{ asset('pm/images/collaborator/mir_sakib.jpg') }}" class="associator-img"
                                     alt="">
                                <p>মীর সাকিব </p>
                    ...
                    <div class="col-md-12 text-center mt-5">
                        ...
                        <div class="row">
                            <div class="offset-md-2 col-md-4">
                                <h3>বাস্তবায়নে</h3>
                                <img src="{{ asset('pm/images/collaborator/a2i_project.png') }}" style="height: 80px; max-width: 100%;"
                                     alt="">
                                <p>এটুআই প্রকল্প</p>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <img src="{{ asset('pm/images/collaborator/e-generation.png') }}" class="" alt="">
...
<!-- bootstrap 4 js -->
<script src="{{ asset('pm/js/vendor/jquery-2.2.4.min.js') }}"></script>
<script src="{{ asset('pm/js/popper.min.js') }}"></script>
<script src="{{ asset('pm/js/bootstrap.min.js') }}"></script>
<script src="{{ asset('pm/js/owl.carousel.min.js') }}"></script>
<script src="{{ asset('pm/js/metisMenu.min.js') }}"></script>
<script src="{{ asset('pm/js/jquery.slimscroll.min.js') }}"></script>
<script src="{{ asset('pm/js/jquery.slicknav.min.js') }}"></script>
...
<!-- others plugins -->
<script src="{{ asset('pm/js/plugins.js') }}"></script>
<script src="{{ asset('pm/js/scripts.js') }}"></script>
        ...
        // demand Supply Analysis
         function hospitalGeneralFilter(design) { 
          ...
          hospitalGeneralFilter(stackedChartedDesign());
                   ...
                   // demand Supply Analysis
         function earlyMarriageFilter(design) { 
           var hospitalGeneralBedchart = AmCharts.makeChart("divisionWiseEarlyMarriage",{
                "dataProvider": [
                      {
                        "group": "General People",
                        "BeforeLockdown": "17825.65977",
           ...
           earlyMarriageFilter(stackedChartedDesign());
