        ...
        <div class="app-header header">
          <div class="container-fluid">
            ...
            <!-- SEARCH -->
              ...
              <div class="d-flex order-lg-2 ml-auto"> <a href="#" data-toggle="search" class="nav-link nav-link-lg d-md-none navsearch"> <svg class="header-icon search-icon" x="1008" y="1248" viewBox="0 0 24 24"  height="100%" width="100%" preserveAspectRatio="xMidYMid meet" focusable="false">
                ...
                <div class="panel panel-default">
                  <div class="panel-body p-0">
                    <div class="btn-group mt-2 mb-2 mr-1">
                     {{-- <button type="button" class="btn btn-outline-primary dropdown-toggle" data-toggle="dropdown" disabled> All Division <span class="caret"></span> </button>
                    ...
                    <div class="btn-group mt-2 mb-2 mr-1">
                      {{--<button type="button" class="btn btn-outline-primary dropdown-toggle" data-toggle="dropdown" disabled> All District <span class="caret"></span> </button>
                      <ul class="dropdown-menu" role="menu">
                      </ul>--}}
                    ...
                    <div class="btn-group mt-2 mb-2 mr-1">
                      {{--<button type="button" class="btn btn-outline-primary dropdown-toggle" data-toggle="dropdown" disabled> All Upazila <span class="caret"></span> </button>
                      <ul class="dropdown-menu" role="menu">
                      </ul>--}}
                    ...
                    <div class="btn-group">
                      ...
                      <div class="col-md-6 pl-0">
                        ...
                        <div class="btn-group">
                            <button class="btn btn-primary-color pl-0" type="submit"> <svg class="header-icon search-icon" x="1008" y="1248" viewBox="0 0 24 24"  height="100%" width="100%" preserveAspectRatio="xMidYMid meet" focusable="false">
                                    <path d="M0 0h24v24H0V0z" fill="none"/>
                                    <path d="M15.5 14h-.79l-.28-.27C15.41 12.59 16 11.11 16 9.5 16 5.91 13.09 3 9.5 3S3 5.91 3 9.5 5.91 16 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z"/>
                                </svg>
                            </button>
