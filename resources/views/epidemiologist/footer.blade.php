...
<script src="{{ asset('superadmin/assets/js/jquery-3.5.1.min.js') }}"></script> 
...
<script src="{{ asset('superadmin/assets/js/circle-progress.min.js') }}"></script> 
...
<script src="{{ asset('superadmin/assets/plugins/peitychart/jquery.peity.min.js') }}"></script> 
<script src="{{ asset('superadmin/assets/plugins/peitychart/peitychart.init.js') }}"></script> 
...
<script src="{{ asset('superadmin/assets/plugins/echarts/echarts.js') }}"></script> 

<!--INTERNAL Chart js --> 

<script src="{{ asset('superadmin/assets/plugins/chart/chart.bundle.js') }}"></script> 
<script src="{{ asset('superadmin/assets/plugins/chart/utils.js') }}"></script> 

<!-- INTERNAL Select2 js --> 

<script src="{{ asset('superadmin/assets/plugins/select2/select2.full.min.js') }}"></script> 
<script src="{{ asset('superadmin/assets/js/select2.js') }}"></script> 

<!--INTERNAL Moment js--> 

<script src="{{ asset('superadmin/assets/plugins/moment/moment.js') }}"></script> 
...
<script src="{{ asset('superadmin/assets/plugins/simplebar/js/simplebar.min.js') }}"></script> 

<!-- INTERNAL Data tables --> 

<script src="{{ asset('superadmin/assets/plugins/datatable/js/jquery.dataTables.js') }}"></script> 
<script src="{{ asset('superadmin/assets/plugins/datatable/js/dataTables.bootstrap4.js') }}"></script> 
<script src="{{ asset('superadmin/assets/plugins/datatable/js/dataTables.buttons.min.js') }}"></script> 
<script src="{{ asset('superadmin/assets/plugins/datatable/js/buttons.bootstrap4.min.js') }}"></script> 
<script src="{{ asset('superadmin/assets/plugins/datatable/js/jszip.min.js') }}"></script> 
<script src="{{ asset('superadmin/assets/plugins/datatable/js/pdfmake.min.js') }}"></script> 
<script src="{{ asset('superadmin/assets/plugins/datatable/js/vfs_fonts.js') }}"></script> 
<script src="{{ asset('superadmin/assets/plugins/datatable/js/buttons.html5.min.js') }}"></script> 
<script src="{{ asset('superadmin/assets/plugins/datatable/js/buttons.print.min.js') }}"></script> 
<script src="{{ asset('superadmin/assets/plugins/datatable/js/buttons.colVis.min.js') }}"></script> 
<script src="{{ asset('superadmin/assets/plugins/datatable/dataTables.responsive.min.js') }}"></script> 
<script src="{{ asset('superadmin/assets/plugins/datatable/responsive.bootstrap4.min.js') }}"></script> 
<script src="{{ asset('superadmin/assets/js/datatables.js') }}"></script> 

<!-- INTERNAL c3.js Charts js--> 

<script src="{{ asset('superadmin/assets/plugins/charts-c3/d3.v5.min.js') }}"></script> 
<script src="{{ asset('superadmin/assets/plugins/charts-c3/c3-chart.js') }}"></script> 
...
<script src="{{ asset('superadmin/assets/js/custom.js?v=2') }}"></script> <script type="text/javascript">
