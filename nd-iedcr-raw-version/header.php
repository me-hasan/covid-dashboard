						...
						<div class="btn-group mt-2 mb-2 mr-1">
							...
							<ul class="dropdown-menu" role="menu">
								<?php
									...
									/*foreach($_divisionAllData as $_indexKey => $_divisionInfo){ #print_r($_districtInfo); exit;?>
									<li><a href="#" rel="<?php echo $_divisionInfo['0']; ?>"<?php if(@$_districtSelName == $_divisionInfo[0]){?> selected="selected"<?php }?>><?php echo $_divisionInfo[0]; ?></a></li>
								<?php }*/ ?>
							</ul>
						</div>
						<div class="btn-group mt-2 mb-2 mr-1">
							...
							<ul class="dropdown-menu" role="menu">
								<?php
									#print_r($_districtAllData); exit;
									/*foreach($_districtAllData as $_indexKey => $_districtInfo){ #print_r($_districtInfo); exit;?>
									<li><a href="#" rel="<?php echo $_districtInfo['1']; ?>"<?php if(@$_districtSelName == $_districtInfo[0]){?> selected="selected"<?php }?>><?php echo $_districtInfo[0]; ?></a></li>
								<?php }*/ ?>
							</ul>
						</div>
						<div class="btn-group mt-2 mb-2 mr-1">
							...
							<ul class="dropdown-menu" role="menu">
								<?php
									/*foreach($_upazilaAllData as $_indexKey => $_upazilaInfo){?>
									<li><a href="#" rel="<?php echo $_upazilaInfo[2]; ?>"<?php if(@$_upazillaSelName == $_upazilaInfo[0]){?> selected="selected"<?php }?>><?php echo $_upazilaInfo[0]; ?></a></li>
								<?php }*/ ?>
							</ul>
						</div>
						<div class="btn-group">
