			...
			<div class="page-main">
				...
				<div class="app-content main-content">
					<div class="side-app">
						...
						<div class="page-header page-header-padding-top">
							<div class="page-leftheader">								
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page"><a href="#">Case Distribution and Forecasting</a></li>
								</ol>
							</div>
						</div>
						<!--End Page header-->
						...
						<iframe id="rtIframeData" width="100%" height="2500" src="http://dev.pipilika.com:9901/" style="overflow-y: hidden" frameborder="0" allowFullScreen="true"></iframe>												<!-- Row-1 -->
						<div class="row d-none">
							<div class="col-xl-12 col-md-12">
								<div class="card">
									<div class="card-header">
										<h3 class="card-title">District Wise Case Distribution</h3>
									...
									<div class="card-body">
										<div class="row mt-4">
											...
											<div class="col-lg-8">
										       <img src="assets/images/chart/case-distribution-and-forecasting.jpg" alt="District Wise Case Distribution Chart" />
											</div>
										</div>
									</div>
								</div>
